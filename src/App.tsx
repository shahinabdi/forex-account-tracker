            ...
            <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl border border-gray-200 p-4 sm:p-6">
              <div className="flex items-center justify-center">
                <div className="text-center">
                  <h3 className="text-sm sm:text-base font-semibold mb-2 text-gray-800">👨‍💻 Developed by</h3>
                  <p className="text-lg sm:text-xl font-bold text-gray-900 mb-3">Shahin ABDI</p>
                  <div className="flex justify-center gap-3 sm:gap-4">
                    <a
                      href="https://www.linkedin.com/in/shahinabdi/"
                      target="_blank"
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 px-3 sm:px-4 py-2 bg-gray-800 text-white rounded-lg hover:bg-gray-900 transition-colors text-xs sm:text-sm font-medium"
                    >
                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 mt-2">
                    💡 Building tools for the trading community
                  </p>
                </div>
              </div>
            </div>
